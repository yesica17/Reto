import { ContainerFooter, LeftFooter, LogoFooter, DescFooter, SocialContainerFooter, SocialIconFooter,  CenterFooter,
  TitleFooter, RightFooter, ContactItemFooter } from "./style";
  ...
  return (
    <ContainerFooter>
            <LeftFooter>
                ...
                <DescFooter>
                    Cidenet Shop ofrece la moda más actual a los mejores precios. Tenemos a su disposición una gran variedad de
