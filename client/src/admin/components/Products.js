...
//console.log(filteredData)
  ...
  return (
    <ContainerProducts>
      ...
      : 
      <div style={{flex: 1, display: "flex", flexDirection: "column", alignItems: "center", margin: "auto", height: 300, justifyContent:"center"}}><RemoveShoppingCart style={{fontSize: 150, color: "Lavender"}}/><h3 style={{color: "SlateGray"}}> 0 resultados</h3><h5 style={{color: "silver"}}>No hay productos para mostrar ahora mismo</h5></div>
        }
    </ContainerProducts>
  );
};
